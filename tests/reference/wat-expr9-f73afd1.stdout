(module
    ...
    (func $7 (type 7) (param i32) (result)
        (local)
        i32.const 1
        local.set 0
        return
    ...
    (export "main0" (func 3))
    (export "test_return_1" (func 4))
    (export "test_return_2" (func 5))
    (export "test_return_3" (func 6))
    (export "test_return_4" (func 7))
