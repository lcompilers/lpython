results = [
    ...
    [('Module', 'a', [], [('Declaration', (1, 1), [('decl', 'i', 'integer', [], [], None)])], []), ('Use', (1, 1), 'a', [('UseSymbol', 'i', None)]), ('Assignment', (1, 1), ('Name', (1, 1), 'i'), ('Num', (1, 1), '5'))],
    [('Use', (1, 1), 'a', [('UseSymbol', 'i', None)]), ('Assignment', (1, 1), ('Name', (1, 1), 'i'), ('Num', (1, 1), '5'))],
    [('Use', (1, 1), 'a', [('UseSymbol', 'i', None)]), ('Assignment', (1, 1), ('Name', (1, 1), 'i'), ('Num', (1, 1), '5'))],
