#ifndef LCOMPILERS_STACKTRACE_H
#define LCOMPILERS_STACKTRACE_H
...
std::string stacktrace2str(const std::vector<LCompilers::StacktraceItem> &d,
    int skip);
