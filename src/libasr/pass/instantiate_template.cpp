...
public:
    ...
    void visit_IntegerConstant(const ASR::IntegerConstant_t &x) {
        tmp = ASR::make_IntegerConstant_t(al, x.base.base.loc, x.m_n, x.m_type);
    }
    ...
    void visit_ListLen(const ASR::ListLen_t &x) {
        ...
        ASR::ttype_t *to_type = ASRUtils::TYPE(ASR::make_Integer_t(al, 
            x.base.base.loc, 4, nullptr, 0));        
        tmp = ASR::make_ListLen_t(al, x.base.base.loc, arg, to_type, value);
    }
