...
namespace LFortran::LPython {
    ...
    Result<ASR::TranslationUnit_t*> python_ast_to_asr(Allocator &al,
        LPython::AST::ast_t &ast, LFortran::LocationManager &lm, diag::Diagnostics &diagnostics, CompilerOptions &compiler_options,
            bool main_module, std::string file_path, std::string &input, bool allow_implicit_casting=false);
