...
f = 5
    ...
    LFortran::ASR::TranslationUnit_t* asr = TRY(LFortran::ast_to_asr(al, *tu,
        diagnostics));
    CHECK(LFortran::pickle(*asr) == "(TranslationUnit (SymbolTable 1 {f: (Function (SymbolTable 2 {f: (Variable 2 f ReturnVar () () Default (Integer 4 []) Source Public Required .false.)}) f [] [(= (Var 2 f) (ConstantInteger 5 (Integer 4 [])) () .false.)] (Var 2 f) Source Public Implementation ())}) [])");
...
f = 4
    ...
    LFortran::ASR::TranslationUnit_t* asr = TRY(LFortran::ast_to_asr(al, *tu,
        diagnostics));
    CHECK(LFortran::pickle(*asr) == "(TranslationUnit (SymbolTable 3 {f: (Function (SymbolTable 4 {f: (Variable 4 f ReturnVar () () Default (Integer 4 []) Source Public Required .false.)}) f [] [(= (Var 4 f) (ConstantInteger 4 (Integer 4 [])) () .false.)] (Var 4 f) Source Public Implementation ())}) [])");
    // ASR -> LLVM
    LFortran::LLVMEvaluator e;
    LFortran::Result<std::unique_ptr<LFortran::LLVMModule>>
        res = LFortran::asr_to_llvm(*asr, diagnostics, e.get_context(), al,
