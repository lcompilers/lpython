#ifndef LFORTRAN_SEMANTICS_AST_SYMBOLTABLE_VISITOR_H
#define LFORTRAN_SEMANTICS_AST_SYMBOLTABLE_VISITOR_H
...
#endif /* LFORTRAN_SEMANTICS_AST_SYMBOLTABLE_VISITOR_H */
