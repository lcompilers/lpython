...
f = 5
    ...
    CHECK(LFortran::pickle(*asr) == "(TranslationUnit (SymbolTable ba2818a1 {f: (Function (SymbolTable 917424ce {f: (Variable 917424ce f 4 (Integer 4 []))}) f [] [(= (Var 917424ce f) (Num 5 (Integer 8 [])))] () (Var 917424ce f) ())}) [])");
...
f = 4
    ...
    // AST -> ASR
    LFortran::ASR::asr_t* asr = LFortran::ast_to_asr(al, *tu);
    CHECK(LFortran::pickle(*asr) == "(TranslationUnit (SymbolTable ba2818a1 {f: (Function (SymbolTable 917424ce {f: (Variable 917424ce f 4 (Integer 4 []))}) f [] [(= (Var 917424ce f) (Num 4 (Integer 8 [])))] () (Var 917424ce f) ())}) [])");
