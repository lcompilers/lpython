...
f = 5
    ...
    CHECK(LFortran::pickle(*asr) == "(TranslationUnit (SymbolTable 1 {f: (Function (SymbolTable 2 {f: (Variable 2 f ReturnVar () Default .false. (Integer 4 []) Source Public)}) f [] [(= (Var 2 f) (ConstantInteger 5 (Integer 4 [])))] (Var 2 f) Source Public Implementation)}) [])");
...
f = 4
    ...
    // AST -> ASR
    LFortran::ASR::TranslationUnit_t* asr = LFortran::ast_to_asr(al, *tu);
    CHECK(LFortran::pickle(*asr) == "(TranslationUnit (SymbolTable 1 {f: (Function (SymbolTable 2 {f: (Variable 2 f ReturnVar () Default .false. (Integer 4 []) Source Public)}) f [] [(= (Var 2 f) (ConstantInteger 4 (Integer 4 [])))] (Var 2 f) Source Public Implementation)}) [])");
