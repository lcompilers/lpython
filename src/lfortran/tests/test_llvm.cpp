...
f = 5
    ...
    CHECK(LFortran::pickle(*asr) == "(TranslationUnit (SymbolTable 673e1f49 {f: (Function f [] [(= (Var ef9dfa7b f) (Num Unimplementedobject (Integer 8 [])))] () (Var ef9dfa7b f) () (SymbolTable ef9dfa7b {f: (Variable f 4 (Integer 4 []))}))}) [])");
