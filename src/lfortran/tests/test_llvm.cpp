...
f = 5
    ...
    CHECK(LFortran::pickle(*ast) == "(Function f [] [] () () [] [] [(Declaration (AttrType TypeInteger [] ()) [] [(f [] ())])] [(= f 5)] [])");
...
f = 4
    ...
    LFortran::AST::TranslationUnit_t* tu = LFortran::parse2(al, source);
    LFortran::AST::ast_t* ast = tu->m_items[0];
    CHECK(LFortran::pickle(*ast) == "(Function f [] [] () () [] [] [(Declaration (AttrType TypeInteger [] ()) [] [(f [] ())])] [(= f 4)] [])");
