...
void emit_elf32_header(X86Assembler &a) {
    ...
    a.add_var("ehdrsize", a.pos()-a.origin()-a.get_defined_symbol("ehdr").value+a.origin());
    ...
    a.add_var("phdrsize", a.pos()-a.origin()-a.get_defined_symbol("phdr").value+a.origin());
    a.add_var("e_phoff", a.get_defined_symbol("phdr").value-a.origin() - section_start);
}

void emit_elf32_footer(X86Assembler &a) {
    uint32_t section_start = 0;
    a.add_var("e_entry", a.get_defined_symbol("_start").value - a.origin()
        - section_start + a.origin());
    a.add_var("filesize", a.pos()-a.origin() - section_start);
}
