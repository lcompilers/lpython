...
named_constant_def
    : id "=" expr { VAR_SYM_INIT($1, $3, Equal, @$); }
    ;
...
var_sym_decl
    ...
    | id "=" expr { VAR_SYM_INIT($1, $3, Equal, @$); }
    | id "=>" expr { VAR_SYM_INIT($1, $3, Assign, @$); }
    | id "*" expr { VAR_SYM_INIT($1, $3, Asterisk, @$); }
    | id "(" array_comp_decl_list ")" { VAR_SYM_DIM($1, $3, None, @$); }
    | id "(" array_comp_decl_list ")" "=" expr {
            VAR_SYM3_DIM_INIT($1, $3, $6, Equal, @$); }
    | id "(" array_comp_decl_list ")" "=>" expr {
            VAR_SYM3_DIM_INIT($1, $3, $6, Assign, @$); }
    | id "[" coarray_comp_decl_list "]" { VAR_SYM_CODIM($1, $3, None, @$); }
    | id "(" array_comp_decl_list ")" "[" coarray_comp_decl_list "]" {
            VAR_SYM_DIM_CODIM($1, $3, $6, None, @$); }
